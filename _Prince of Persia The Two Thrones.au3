...
#AutoIt3Wrapper_Outfile=_Prince of Persia The Two Thrones.exe
...
DirCreate(@AppDataCommonDir & "\SalFisher47\UniGame Launcher\PoP3")
FileInstall("POP_ProgramData.ini", @AppDataCommonDir & "\SalFisher47\UniGame Launcher\PoP3\PoP3.ini", 0)
$patched_ProgramData = IniRead(@AppDataCommonDir & "\SalFisher47\UniGame Launcher\PoP3\PoP3.ini", "EXE", "patched", 0)
...
If RegRead("HKLM\SOFTWARE\UBISOFT\Prince of Persia The Two Thrones\1.00.999", "Product_Path") <> @ScriptDir Then
	RegWrite("HKLM\SOFTWARE\UBISOFT\Prince of Persia The Two Thrones\1.00.999", "Product_Path", "REG_SZ", @ScriptDir)
	RegWrite("HKLM\SOFTWARE\UBISOFT\Prince of Persia The Two Thrones\1.00.999", "Product_Executable", "REG_SZ", "PrinceOfPersia.exe")
	RegWrite("HKLM\SOFTWARE\UBISOFT\Prince of Persia The Two Thrones\1.00.999", "Product_Language", "REG_SZ", 9)
	RegWrite("HKLM\SOFTWARE\UBISOFT\Prince of Persia The Two Thrones\1.00.999", "Product_Release", "REG_SZ", "Retail EMEA")
EndIf

If RegRead("HKLM\SOFTWARE\UBISOFT\Prince of Persia The Two Thrones\1.00.999", "Profiles_Path") <> @ScriptDir Then
